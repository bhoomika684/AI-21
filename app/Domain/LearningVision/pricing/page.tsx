...
export default function LearningVisionPricingPage() {
  const router = useRouter()

  return (
    <>
      <LearningVisionHeader currentPage="pricing" />
      <div className="min-h-screen bg-red-50">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl lg:text-5xl font-bold text-white">
                LearningVision Pricing
              </h1>
              <p className="text-xl text-red-100 max-w-3xl mx-auto">
                Choose the perfect plan for your learning and development needs. From small businesses to enterprise companies.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <ul className="text-gray-600 text-sm mb-6 space-y-1 text-center">
                  ...
                  <li>1 Team Member</li>
                  <li>Max 10 Learning Sessions Per Week</li>
                  <li>Email Support</li>
                </ul>
              ...
              >
                ...
                <ul className="text-gray-600 text-sm mb-6 space-y-1 text-center">
                  <li>Advanced AI Learning Paths</li>
                  <li>Smart Content Recommendations</li>
                  <li>2-5 Team Members</li>
                  <li>Unlimited Learning Sessions</li>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose LearningVision?</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Experience the power of AI-driven learning with features designed to enhance your training and development programs.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                "Progress Tracking & Predictive Insights",
                "Seamless L&D System Integration",
        ...
        <section className="py-20 bg-gradient-to-r from-red-600 to-red-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-red-100 max-w-3xl mx-auto">
                Join companies already using LearningVision to create smarter, more effective training programs.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  onClick={() => router.push("/Domain/LearningVision")}
                >
                  Learn More
                </Button>
              </div>
