...
//       <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-blue-200 to-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
//       <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-green-200 to-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse delay-1000"></div>
...
//         >
//           <motion.p
//             className="text-sm font-medium text-green-600 uppercase tracking-wide"
//             initial={{ opacity: 0 }}
...
//           >
//             AI 21, the Choice of 500K+ Visionary Leaders Worldwide.
//           </motion.p>
//         </motion.div>
...
//         >
//           {/* <p className="text-gray-500 mb-4">Hover over each feature to explore more details</p> */}
//           <motion.div
