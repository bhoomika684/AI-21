...
//   return (
//     <section
//       className="relative overflow-hidden min-h-screen flex items-center justify-center font-sans py-12"
//     >
//       {/* Video Background */}
//       <video
//         autoPlay
...
//         poster="/ai21-bg.jpg"
//       >
//         <source src="/ai21-bg.mp4" type="video/mp4" />
...
//       {/* Background gradient circles - these will appear on top of the video */}
...
//                 className="text-4xl lg:text-5xl font-extrabold text-white leading-tight drop-shadow-lg"
//               >
//                 One Platform, 21 Domains Covered
//                 <br />
//                 <span className="text-white font-extrabold">Where AI Meets Domain-Specific Requirements</span>
//               </motion.h1>
...
//               >
//                 AI-TwentyOne : AI-powered products transforming challenges into solutions across domains.
//               </motion.p>
//             </div>
...
const HeroSection = () => {
  ...
  return (
    <section
      className="relative overflow-hidden min-h-screen flex items-center justify-center font-sans py-12"
      style={{
        backgroundImage: 'url(https://images.pexels.com/photos/18069156/pexels-photo-18069156.png)',
          ...
          >
            <div className="space-y-6">
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                className="text-4xl lg:text-5xl font-extrabold text-red-700 leading-tight drop-shadow-lg text-center"
              >
                One Platform, 21 Domains Covered
                <br />
                <span className="text-white font-extrabold">Where AI Meets Domain-Specific Requirements</span>
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.4 }}
                className="text-lg md:text-xl text-white max-w-2xl mx-auto drop-shadow-md text-center"
              >
                <span className="text-red-700">AI-<span className="italic">TwentyOne</span></span> : AI-powered products transforming challenges into solutions across domains.
              </motion.p>
            </div>
