// /**
//  * Header Component - Main navigation bar for the application
//  *
//  * Features:
//  * - Responsive design with mobile hamburger menu
//  * - Dropdown navigation for recruitment services
//  * - Authentication buttons (Login/Get Started)
//  * - Smooth animations and hover effects
//  * - Integration removed as requested
//  *
...
//   // Navigation items configuration - Integration removed as requested
...
//   // Recruitment services for dropdown menu
...
//     { name: "Test", href: "/recruitment/test" },
...
//             <Link href="/" className="text-2xl font-bold text-gray-900 hover:text-green-700 transition-colors">
//               AI 21
//             </Link>
//           </div>
...
//                   {item.name}
//                 </Link>
//                 {/* Dropdown menu for recruitment services */}
//                 {item.hasDropdown && (
