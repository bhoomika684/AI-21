...
interface HireVisionHeaderProps {
  currentPage?: string
  isMainHireVisionPage?: boolean
}

export default function HireVisionHeader({ currentPage, isMainHireVisionPage = false }: HireVisionHeaderProps) {
  const [isMenuOpen, setIsMenuOpen] = useState(false)

  const productLinks = [
    {
      name: "HireVision-Assessment",
      href: "/Domain/HireVision/HireVision-Assessment",
    },
    {
      name: "HireVision-CVAnalysis",
      href: "/Domain/HireVision/HireVision-CVAnalysis",
    },
    {
      name: "HireVision-Interviewer",
      href: "/Domain/HireVision/HireVision-Interviewer",
    },
  ]
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center justify-center w-full relative">
            <div className="flex space-x-8">
              ...
              <Link 
                href="/Domain/HireVision/pricing" 
